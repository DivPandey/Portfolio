            ...
            <Container>
                <Row className='g-5'>
                    <Col md={4}>
                        ...
                        <h2 style={{color:'#fe3e57',fontSize:'25px',marginTop:'13px',fontWeight:700 }}>Communication Skills / Soft Skills</h2>
                        </div>
                    </Col>
                    ...
                    <Col md={4}>
                        ...
                        <h2 style={{color:'#f1f965',fontSize:'25px',marginTop:'13px',fontWeight:700 }}>Analytical Skills</h2>
                        </div>
                    </Col>
                    <Col md={4}>
                        ...
                        <h2 style={{color:'#39c4ff',fontSize:'25px',marginTop:'13px',fontWeight:700 }}>Curiosity and Creativity</h2>
                        </div>
                    </Col>
                </Row>
            </Container>
